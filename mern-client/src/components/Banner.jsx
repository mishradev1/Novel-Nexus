        ...
        <div className='flex w-full flex-col md:flex-row justify-between items-center gap-12 py-40'>
            ...
            <div className='md:w-1/2 space-y-8 h-full'>
                ...
                <p className='md:w-4/5'>
                    "Welcome to Novel Nexus, your literary haven online,<br/>
                    Where stories of all genres await, ready to be found.<br/>
                    Explore our curated collection, from classics to modern tales,<br/>
                    Join us on a journey through the magic of words unveiled."
                </p>
