...
import FavBookImg from '../assets/book-inventory-starter-files-main/assets/favoritebook.jpg'
  ...
  return (
    <div className='px-4 lg:px-24 my-20 flex flex-col md:flex-row justify-between items-center gap-12'>
      ...
      <div className='md:w-1/2 space-y-6'>
        ...
        <p className='mb-10 text-lg md:w-5/6'>Embark on a journey of literary exploration with Novel Nexus. Discover captivating stories, 
        connect with fellow book lovers, and indulge in the joy of reading.!</p>
          {/* stats */}
          <div className='flex flex-col sm:flex-row justify-between gap-6 md:w-3/4 my-14'>
            ...
            <div>
              ...
              <p className='text-base'>Books Delivered</p>
            </div>
          </div>
